...
export function nlpExtractRelations(article) {
  ...
  // F2: regex spans carry stopword debris ("they share similar", "are") that
  // would become keyword nodes. Trim leading/trailing stopwords; drop spans
  // with no content word or over 4 words.
  const clean = (span) => {
