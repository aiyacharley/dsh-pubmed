...
export function nlpExtractRelations(article) {
  ...
  const re = /\b([a-z][a-z0-9-]+(?:\s+[a-z][a-z0-9-]+){0,2})\s+((?:regulat|promot|inhibit|produc|driv|mediat|induc|enhanc|modulat|influenc|increas|reduc|alter|activat|suppress|impair|restor|exacerbat|aggravat|govern|shape|predict|stratify|disrupt|trigger)\w*)\s+([a-z][a-z0-9-]+(?:\s+[a-z][a-z0-9-]+){0,2})[\s.,;]/gi
  let m
